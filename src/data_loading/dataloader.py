...
class OrganOfferDataset(Dataset):
    def __init__(self, X, y, input_space, criteria_space, data_dict, degree=1,transform=None, fake_y=False):
        ...
        if fake_y:
            ...
            self.sample_weight=(mask*(1-p_neg)+(1-mask)*p_neg).astype('float32')
