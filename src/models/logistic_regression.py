...
class LogisticEstimator(Estimator):
    def __init__(self,input_space, criteria_space, data_description,n_clusters=10,degree=1,random_state=None, **kwargs):
    ...
    def create_logistic_regressor(self, random_state):
        return LogisticRegression(penalty='none',solver='saga',random_state=random_state,class_weight='balanced',fit_intercept=False)
    ...
    def fit(self, X, y, **kwargs):
        ...
        self.regressors=[self.create_logistic_regressor(random_state) for i in range(self.n_clusters)]
