...
from src.models.loss import AE_Loss, BCE_Loss, MoE_Loss, Lipschitz

        
class iTransplantEstimator(NeuralEstimator):
    def __init__(self,input_space, criteria_space, data_description,h_dim=20,num_experts=10,k=4,degree=1,lambda_=0.01,num_layers=3,random_state=None, **kwargs):
    ...
    def generate_model(self):
        return iTransplant(self.x_dim,self.c_dim,self.h_dim,layer_n=self.num_layers,num_experts=self.num_experts,k=self.k,sigma=torch.sigmoid,threshold=0)
