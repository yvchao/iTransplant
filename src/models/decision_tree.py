...
class DecisionTreeEstimator(Estimator):
    def __init__(self,input_space, criteria_space, data_description,max_depth=10, n_clusters=10,degree=1,random_state=None, **kwargs):
    ...
    def create_decision_tree(self,random_state,max_depth):
        return DecisionTreeClassifier(random_state=random_state,class_weight='balanced',max_depth=max_depth)
    ...
    def fit(self, X, y, **kwargs):
        ...
        self.regressors=[self.create_decision_tree(random_state,self.max_depth) for i in range(self.n_clusters)]
